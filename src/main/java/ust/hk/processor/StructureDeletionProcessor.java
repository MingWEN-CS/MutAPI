...
public class StructureDeletionProcessor extends CiviProcessor {
	...
	public StructureDeletionProcessor(int sourceStart, int sourceEnd, List<APIUsage> usages) {
	...
	public StructureDeletionProcessor(Method targetMethod, List<APIUsage> usages) {
	...
	public void process(CtElement element) {
		// simply delete the selected element
